...
/**
 * 绑定服务注意事项：
 * 1.bindService(intentStart, connect, BIND_AUTO_CREATE)可以启动服务，当服务未开启的时候
...
//                        mListener.onRateGet((Float) msg.obj);
        ...
        public void stopTask() {
            ...
            mThreads.clear();
//            mListener.onThreadUpdate(0);
//            mListener.onRateGet(0);
        }
        ...
        private void handleCPURate(Float cpuRateNow) {
            ...
            Log.d(TAG, "CPURateNow: "+cpuRateNow);
